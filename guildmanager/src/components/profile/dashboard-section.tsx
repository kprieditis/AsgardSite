        ...
        <section className="rounded-[2rem] border border-sweyellow bg-sweblue/20 p-5 shadow-[0_0_40px_rgba(0,82,147,0.5)] backdrop-blur-xl">
          <div className="rounded-[1.5rem] border border-sweblue bg-slate-950/35 p-5 sm:p-6 lg:p-7">
            <div className="grid gap-7 lg:grid-cols-[19rem_1fr] lg:items-stretch">
              <aside className="relative rounded-2xl border border-white/10 bg-slate-950/40 p-5 text-left shadow-[inset_0_0_28px_rgba(0,82,147,0.16)] lg:w-76">
                <div className="relative w-fit overflow-hidden rounded-3xl border border-sweyellow bg-slate-950/60 p-1 shadow-[0_0_28px_rgba(254,203,0,0.16)]">
                    {session.user.image ? (
                    <Image
